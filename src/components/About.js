            ...
            <Row className="text-center py-5">
              <Col>
                <h3 className="mb-4 mia-cursive">
                  Ultimate{" "}
                  <span className="mia-rock-salt">Nightlife Destination</span>
                </h3>
                <p className="lead mb-4" style={{ color: "white" }}>
                  Located in the heart of downtown Toronto, Club Mia is where
                  elegance meets excitement. Our venue is designed to cater to
                  those who seek a premium atmosphere with high-energy, where
                  every night is a celebration and every guest is treated like a
                  VIP.
                </p>
                <p className="mb-4" style={{ color: "white" }}>
                  Step inside and discover why we are the talk of Toronto’s
                  nightlife scene. With custom-designed lights and the highest
                  quality music systems, every detail at Club Mia is crafted to
                  offer an unforgettable experience.
                </p>
                <span className="d-block mb-4" style={{ color: "white" }}>
                  Come be a part of Club Mia
                </span>

                <div className="packages-button-container">
                  <button className="packages-button">Connect with Us</button>
                </div>
              </Col>
            </Row>
            <Row>
