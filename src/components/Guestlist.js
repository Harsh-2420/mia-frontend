  ...
  return (
    <>
      <Form onSubmit={handleSubmit} className="guestlist-form-container">
        <Row>
          <Col xs={6}>
            <Form.Group className="guestlist-form-group" controlId="formName">
              <Form.Control
                type="text"
          ...
          <Col xs={6}>
            <Form.Group className="guestlist-form-group" controlId="formPeople">
              <Form.Control
                style={{
                  marginBottom: "10%",
                }}
        ...
        <Row>
          <Col xs={6}>
            <Form.Group className="guestlist-form-group" controlId="formDate">
              <Form.Control
                style={{
                  marginBottom: "10%",
                }}
        ...
        <Button className="w-100 mt-3 guestlist-form-submit">SUBMIT</Button>
      </Form>
    </>
  );
}
